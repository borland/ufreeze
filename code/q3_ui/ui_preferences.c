...
#define ID_BACK					138
//freeze
#define ID_ICECHIPS 139
#define ID_WEATHER 140
#define ID_CHATFILTER 141
//freeze
//unlagged
#define ID_DELAG 142
//unlagged
...
//freeze
	menuradiobutton_s icechips;
	menuradiobutton_s weather;
	menuradiobutton_s chatfilter;
//freeze
//unlagged
	menuradiobutton_s delag;
//unlagged
	menubitmap_s		back;
...
//freeze
	s_preferences.icechips.curvalue = trap_Cvar_VariableValue( "cg_iceChips" ) != 0;
	s_preferences.weather.curvalue = trap_Cvar_VariableValue( "cg_weather" ) != 0;
	s_preferences.chatfilter.curvalue = trap_Cvar_VariableValue( "cg_chatFilter" ) != 0;
//freeze
//unlagged
	s_preferences.delag.curvalue = trap_Cvar_VariableValue( "cg_delag" ) != 0;
//unlagged
}
...
//freeze
	case ID_ICECHIPS:
		trap_Cvar_SetValue( "cg_iceChips", s_preferences.icechips.curvalue );
		break;

	case ID_WEATHER:
		trap_Cvar_SetValue( "cg_weather", s_preferences.weather.curvalue );
		break;

	case ID_CHATFILTER:
		trap_Cvar_SetValue( "cg_chatFilter", s_preferences.chatfilter.curvalue );
		break;
//freeze

//unlagged
	case ID_DELAG:
		trap_Cvar_SetValue( "cg_delag", s_preferences.delag.curvalue );
		break;
//unlagged
...
//freeze
	y += BIGCHAR_HEIGHT+2;
	s_preferences.icechips.generic.type     = MTYPE_RADIOBUTTON;
	s_preferences.icechips.generic.name	   = "Ice Chips:";
	s_preferences.icechips.generic.flags	   = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_preferences.icechips.generic.callback = Preferences_Event;
	s_preferences.icechips.generic.id       = ID_ICECHIPS;
	s_preferences.icechips.generic.x	       = PREFERENCES_X_POS;
	s_preferences.icechips.generic.y	       = y;

	y += BIGCHAR_HEIGHT+2;
	s_preferences.weather.generic.type     = MTYPE_RADIOBUTTON;
	s_preferences.weather.generic.name	   = "Outdoor Weather:";
	s_preferences.weather.generic.flags	   = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_preferences.weather.generic.callback = Preferences_Event;
	s_preferences.weather.generic.id       = ID_WEATHER;
	s_preferences.weather.generic.x	       = PREFERENCES_X_POS;
	s_preferences.weather.generic.y	       = y;

	y += BIGCHAR_HEIGHT+2;
	s_preferences.chatfilter.generic.type     = MTYPE_RADIOBUTTON;
	s_preferences.chatfilter.generic.name	   = "Chat Filter:";
	s_preferences.chatfilter.generic.flags	   = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_preferences.chatfilter.generic.callback = Preferences_Event;
	s_preferences.chatfilter.generic.id       = ID_CHATFILTER;
	s_preferences.chatfilter.generic.x	       = PREFERENCES_X_POS;
	s_preferences.chatfilter.generic.y	       = y;
//freeze

//unlagged
	y += BIGCHAR_HEIGHT+2;
	s_preferences.delag.generic.type     = MTYPE_RADIOBUTTON;
	s_preferences.delag.generic.name	   = "Hitscan Lag Compensation:";
	s_preferences.delag.generic.flags	   = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_preferences.delag.generic.callback = Preferences_Event;
	s_preferences.delag.generic.id       = ID_DELAG;
	s_preferences.delag.generic.x	       = PREFERENCES_X_POS;
	s_preferences.delag.generic.y	       = y;
//unlagged
...
//freeze
	Menu_AddItem( &s_preferences.menu, &s_preferences.icechips );
	Menu_AddItem( &s_preferences.menu, &s_preferences.weather );
	Menu_AddItem( &s_preferences.menu, &s_preferences.chatfilter );
//freeze
//unlagged
	Menu_AddItem( &s_preferences.menu, &s_preferences.delag );
//unlagged
