...
void UpdateTournamentInfo( void ) {
  ...
  int score1, score2;
	...
	if ( level.clients[playerClientNum].sess.sessionTeam == TEAM_SPECTATOR || level.clients[playerClientNum].sess.sessionTeam == TEAM_BLUECOACH || level.clients[playerClientNum].sess.sessionTeam == TEAM_REDCOACH ) {
#ifdef MISSIONPACK
