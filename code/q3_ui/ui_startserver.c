...
static void ServerOptions_Start( void ) {
	...
	case GT_TEAM:
		trap_Cvar_SetValue( "ui_team_capturelimit", flaglimit );
...
static void ServerOptions_SetMenuItems( void ) {
	...
	case GT_TEAM:
		Com_sprintf( s_serveroptions.flaglimit.field.buffer, 4, "%i", (int)Com_Clamp( 0, 999, trap_Cvar_VariableValue( "ui_team_capturelimit" ) ) );
