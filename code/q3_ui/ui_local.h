...
//freeze
extern	vmCvar_t		ui_iceChips;
extern	vmCvar_t		ui_weather;
extern	vmCvar_t		ui_chatFilter;
//freeze
//unlagged
extern	vmCvar_t		ui_delag;
//unlagged
...
//freeze
extern int			UI_Cvar_VariableIntegerValue( const char *name );
//freeze
