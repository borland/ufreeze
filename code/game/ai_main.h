...
//freeze
	qboolean grapple;								//set to qtrue when the bot is going to press the grapple button
	qboolean sneaky;								//set to qtrue if the bot wants to be sneaky
	qboolean stopfighting;					//set to qtrue if the bot wants to stop fighting
	int healthdelta;								//health point delta, calculated in BotFindEnemy
	float healthdecreasetime;				//last time health decreased by more than 1
	float sneaktime;								//time bot started/stopped sneaking
//freeze
} bot_state_t;
